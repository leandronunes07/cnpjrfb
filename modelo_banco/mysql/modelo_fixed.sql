...
DROP SCHEMA IF EXISTS `cnpjrfb_2026` ;
...
-- Base de dados para gravar os dados públicos de CNPJ da Receita Federal do Brasil
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `cnpjrfb_2026` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `cnpjrfb_2026` ;
...
CREATE TABLE IF NOT EXISTS `simples` (
  ...
  CONSTRAINT `fk_simples_estabelecimento1`
    ...
    REFERENCES `cnpjrfb_2026`.`estabelecimento` (`cnpj_basico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `socios` (
  ...
  CONSTRAINT `fk_socios_quals1`
    ...
    REFERENCES `cnpjrfb_2026`.`quals` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  CONSTRAINT `fk_empresa_natju1`
    ...
    REFERENCES `cnpjrfb_2026`.`natju` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
DROP USER IF EXISTS 'cnpjrfb_2026'@'%';
CREATE USER 'cnpjrfb_2026'@'%' IDENTIFIED BY '123456';
GRANT ALL PRIVILEGES ON cnpjrfb_2026.* TO 'cnpjrfb_2026'@'%';
